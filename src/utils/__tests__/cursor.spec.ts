...
describe('Cursor', () => {
  ...
  it('should encode cursor', () =>
    expect(generateCursor(cursorValue)).toBe(encodedCursorValue));

  it('should decode cursor', () =>
    expect(decodeCursor(encodedCursorValue)).toEqual(cursorValue));
  ...
  it.each([
    ...
    'should return undefined when cursor is malformed - case: %p',
    (_, encodedCursorValue) => {
